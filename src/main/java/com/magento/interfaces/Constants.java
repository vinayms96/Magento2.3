package com.magento.interfaces;

public interface Constants {
	final String PROP_PATH = "./../magento_data/site_data.properties";
	final String EXCEL_TEST_PATH = "./../magento_data/test_data.xlsx";
	final String EXCEL_UPDATE_PATH = "./../magento_data/update_test_data.xlsx";
